...
<div class="m-4 grid grid-cols-[1fr_4fr] bg-white round-lg shadow-md justify-center">
    ...
    <div class="relative">
        <div class="absolute top-0 w-full z-50 h-16 flex items-center justify-between p-6 border-b-2 mt-px border-slate-100">
        </div>
        <div class="flex flex-col h-full relative justify-end bg-cover bg-white pb-16">
            <div class="p-6 flex h-full flex-col gap-3 justify-end">
            </div>
            <hr>
            <div class="absolute bottom-0 h-16 w-full flex items-center px-6 gap-2">
                <form class="w-full overflow-hidden" id="message-send">
                    <input disabled type="text" placeholder="Select a chat to start typing" class="w-full h-9 border-2 border-slate-200 bg-white placeholder:text-sm placeholder:truncate px-2 placeholder:text-slate-500  outline-transparent rounded-md leading-10" />
                </form>
                <button disabled class="p-2 cursor-default bg-slate-200 rounded-md" form="message-send" type="submit">
