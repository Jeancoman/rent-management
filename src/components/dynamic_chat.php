...
<div class="m-4 grid grid-cols-[1fr_4fr] bg-white round-lg shadow-md justify-center">
    ...
    <div class="relative">
        <div class="absolute top-0 w-full z-50 bg-white h-16 flex items-center justify-between p-6 border-b-2 mt-px border-slate-100">
            <h1 class="font-bold"><?= $inverse_user["name"] ?></h1>
        </div>
        <div class="flex flex-col max-h-screen flex-1 relative justify-end bg-cover bg-white pb-16 overflow-auto">
            <div class="p-6 flex flex-col h-screen gap-3 justify-end overflow-auto pointer-events-auto">
                <?php if ($messages) : ?>
                        ...
                        <?php if ($message["user_id"] == $inverse_user["id"]) : ?>
                            <div class="flex justify-start">
                                <div class="bg-slate-200 max-w-md w-fit rounded-md p-2 px-3 shadow">
                                    ...
                                    <p class="text-xs text-end text-slate-600 font-normal">
                                    </p>
                                </div>
                            </div>
